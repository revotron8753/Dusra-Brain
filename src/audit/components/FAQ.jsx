...
const faqs = [
  { q: 'What happens in the AI Marketing Audit call?', a: 'We analyze your current operations and identify where AI can save time, reduce costs, and increase output.' },
  ...
  { q: 'How long does it take to implement AI Marketing?', a: 'Initial systems are set up quickly, and we continuously improve and expand based on your needs.' },
  ...
  { q: 'How does the monthly engagement work?', a: 'We continuously monitor, optimize, and add new AI Marketing to improve efficiency and growth.' },
  { q: 'Can I scale this across multiple teams or departments?', a: 'Yes. Once set up, AI Marketing can be expanded across sales, marketing, operations, and more.' },
  ...
  { q: "What's the next step?", a: 'Book an AI Marketing Audit and see exactly how AI can transform your business.' },
]
